...
export function OverviewTab() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div>
        <h2 className="text-lg md:text-xl font-semibold mb-1 md:mb-2">Today's Overview</h2>
        <p className="text-neutral-500 text-sm md:text-base">Key metrics and important information at a glance</p>
      </div>
